...
function saveSearchJs(filename, sidebar) {
    // Variables
...
const SearchHelper = (function() {
    ...
    const getHelpText = function() {
        ...
        help += "  strict-only - Use an array of namespace, type, member, constructor, field,\\n";
        help += "    event, property, method, static, or operator to filter out types of objects,\\n";
        help += "    seperated by a comma ( , ). Each category must be met to be accepted as a\\n";
        help += "    result.\\n";
        help += "      Example: strict-only:static,method\\n\\n";
        
		help += "  only - Use an array of namespace, type, member, constructor, field,\\n";
        help += "    event, property, method, static, or operator to filter out types of objects,\\n";
        help += "    seperated by a comma ( , ).\\n";
		help += "      Example: only:type,namespace\\n\\n";
        
		help += "  exclude - Use namespace, type, and member to exclude those objects from search,\\n";
        help += "    seperated by a comma ( , ).\\n";
		...
		help += "  accept-all - Set this to true to search for every object.\\n";
		help += "      Example: accept-all:true";
...
exports.saveSearchJs = saveSearchJs;
