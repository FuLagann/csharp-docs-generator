                        ...
                        case "T":
                            {
                                ...
                                const html = template_1.compileBase(index_1.getTemplateUri(args.template.baseUri), template_1.compileType(index_1.getTemplateUri(args.template.typeUri), temp, typeDetails, args.template), args.template, temp.breadcrumbs);
