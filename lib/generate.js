...
function generateCssAndScriptFiles(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield generateSupplementaryFile(path.join(args.outputPath, "/images/"), args.templateUris.localImages || [], true);
    });
}
...
function generateSupplementaryFile(basePath, files, useBase64 = false) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
