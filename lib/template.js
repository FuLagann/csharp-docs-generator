...
exports.compileMethod = exports.compileEvent = exports.compilePropety = exports.compileField = exports.compileType = exports.compileNamespace = exports.compileIndex = exports.compileFooter = exports.compileHeader = exports.compileSidebar = exports.compileBaseNamespace = exports.compileBase = exports.compileBaseIndex = exports.getNamespaceTypes = void 0;
...
const Helper = require("./template-helpers");
// External libraries
...
function compileBaseIndex(args, namespaces) {
    return __awaiter(this, void 0, void 0, function* () {
        // Variables
        const filename = args.templateUris.base;
        return ejs.render(read_file_1.readFile(filename).replace(/(?<=\S)\s+(?=<\/code>)/gm, "").trim(), {
            uris: {
...
exports.compileBaseIndex = compileBaseIndex;
 ...
 * @returns Returns the compiled template code.*/
function compileBaseNamespace(args, namespace, types) {
    return __awaiter(this, void 0, void 0, function* () {
        // Variables
        const filename = args.templateUris.base;
        return ejs.render(read_file_1.readFile(filename).replace(/(?<=\S)\s+(?=<\/code>)/gm, "").trim(), {
...
exports.compileBaseNamespace = compileBaseNamespace;
...
function compileIndex(filename, namespaces) {
    // Variables
    const args = index_1.getArguments();
    return ejs.render(read_file_1.readFile(filename), {
        uris: {
...
function compileNamespace(filename, context) {
    // Variables
    const args = index_1.getArguments();
    return ejs.render(read_file_1.readFile(filename), {
        uris: {
    ...
    return {
        ...
        parameters: {
            exists: (doesArrayItemExist(format.parameters) ||
                doesArrayItemExist(details.parameters)),
        ...
        typeParameters: {
            exists: (doesArrayItemExist(format.typeParameters) ||
                doesArrayItemExist(details.genericParameters) ||
                doesArrayItemExist(details.typeInfo ?
