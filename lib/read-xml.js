...
function gatherApiMapFromTypePath(api, typePath, xmls) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < xmls.length; i++) {
            content = read_file_1.readFile(xmls[i]);
            found = yield generateMemberFromTypePath(api, parser.parseFromString(content, "text/xml"), typePath);
            if (found) {
                break;
            }
        }
...
function generateMemberFromTypePath(api, xml, typePath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (members.length > 0) {
            ...
            let format = yield setDataMembers(members[0]);
            format.type = type;
...
function generateMembers(api, xml) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < members.length; i++) {
            ...
            let format = yield setDataMembers(members[i]);
            format.type = type;
...
function setDataMembers(member) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const parameters = yield gatherNameDescriptionList(member.getElementsByTagName("param"), "name");
        const exceptions = yield gatherNameDescriptionList(member.getElementsByTagName("exception"), "cref");
        const typeParameters = yield gatherNameDescriptionList(member.getElementsByTagName("typeparam"), "name");
        for (let i = 0; i < TEXT_CONTENTS.length; i++) {
            format.setTextContent(TEXT_CONTENTS[i][0], yield getTextContent(member, TEXT_CONTENTS[i][0], TEXT_CONTENTS[i][1]));
        }
...
function gatherNameDescriptionList(members, attrName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < members.length; i++) {
            ...
            let desc = (yield getTextContentFromMember(members[i], "No description")).trim();
...
function getTextContent(member, id, defaultText) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let desc = (yield getTextContentFromMember(elems[0], defaultText)).trim();
        if (desc != "" && !desc.endsWith(".")) {
            desc += ".";
        }
        return desc;
                    ...
                    case "see":
                        {
                            ...
                            if (child.hasAttribute("langword")) {
                                ...
                                let link = (typeMatches[1].startsWith("System") ?
                                    ...
                                    yield createInternalLink(typeMatches[1]));
...
function createInternalLink(typePath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const list = yield generate_1.generateTypeList(args);
