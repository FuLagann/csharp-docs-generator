...
exports.createInternalLink = exports.createSystemLink = exports.getXmls = exports.getApiDoc = exports.markdown = void 0;
...
// Variables
exports.markdown = markdownIt({ html: true }).use(prism);
const TEXT_CONTENTS = [
...
exports.createSystemLink = createSystemLink;
...
function gatherNameDescriptionList(members, attrName) {
    ...
    for (let i = 0; i < members.length; i++) {
        ...
        results.push({ name: name, description: exports.markdown.render(desc) });
    }
    return results;
}
...
function getMarkdownTextContent(member, id, defaultText) {
    ...
    return exports.markdown.render(desc);
}
...
function trimTextContent(content) {
