...
function getTemplate(templateID, defaultUris) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            template.localImages = updatePathForArray(index_1.TEMP_FOLDER, template.localImages || defaultUris.localImages);
            ...
            template.globalImages = updatePathForArray(index_1.TEMP_FOLDER, template.globalImages || defaultUris.globalImages);
            return template;
        }
        catch (e) {
            console.log(e);
...
function gatherUris(templatePath, template, yamlUri) {
    ...
    template.localImages = getFilenames(template.includeDefaultImages, basePath, yamlJson.localImages, template.localImages);
