...
function uploadArtifacts() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const files = fs.existsSync(exports.TEMP_FOLDER + "debug.txt") ? [exports.TEMP_FOLDER + "debug.txt"] : [];
        if (files.length > 0) {
            yield client.uploadArtifact(name, files, exports.TEMP_FOLDER, { continueOnError: true });
        }
    });
}
