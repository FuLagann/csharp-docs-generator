...
let dependencies = [exports.TEMP_FOLDER + exports.NETSTANDARD_XML];
let sharpCheckerExe;
let xmlApi;
...
function generateDocs() {
    return __awaiter(this, void 0, void 0, function* () {
        xmlApi = yield read_xml_1.gatherApiMap(args);
        try {
...
function uploadArtifacts() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (files.length > 0) {
            yield client.uploadArtifact(name, files, exports.TEMP_FOLDER + "debugging/", { continueOnError: true });
        }
    });
}
