...
let typeList;
for (let i = 1; i <= 32; i++) {
    exports.NETSTANDARD_XMLS.push(`${exports.TEMP_FOLDER}netstandard-p${i}.xml`);
}
...
function generateDocs() {
    return __awaiter(this, void 0, void 0, function* () {
        dependencies = read_xml_1.getXmls(args.binaries).concat(exports.NETSTANDARD_XMLS);
        if (args.dependencies.length > 0) {
            dependencies = dependencies.concat(read_xml_1.getXmls(args.dependencies));
        }
