...
exports.NETSTANDARD_XML = "netstandard.xml";
...
function downloadTools() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield tools.downloadTool(NETSTANDARD_API, exports.TEMP_FOLDER + exports.NETSTANDARD_XML);
...
function generateDocs() {
    return __awaiter(this, void 0, void 0, function* () {
        xmlApi = read_xml_1.gatherApiMap(args);
        try {
...
function uploadArtifacts() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const files = [
            exports.TEMP_FOLDER + "debugging/xml-type-path.txt",
            exports.TEMP_FOLDER + "debugging/compiled-type-path.txt",
            exports.TEMP_FOLDER + "debugging/type.json",
            exports.TEMP_FOLDER + "debugging/list.json",
        ];
        yield client.uploadArtifact(name, files, exports.TEMP_FOLDER + "debugging");
    });
}
